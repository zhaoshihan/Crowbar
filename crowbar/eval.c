                           ...
                           Expression *left, Expression *right)
{
    ...
    if (left_val.type == CRB_INT_VALUE
        ...
        eval_binary_int(inter, expressionType,
        ...
        eval_binary_double(inter, expressionType,
        ...
        result.type = CRB_BOOLEAN_VALUE;
        result.u.boolean_value
            = eval_compare_string(expressionType, &left_val, &right_val,
                                  left->line_number);
    } else if (left_val.type == CRB_NULL_VALUE
               || right_val.type == CRB_NULL_VALUE) {
        result.type = CRB_BOOLEAN_VALUE;
        result.u.boolean_value
            = eval_binary_null(inter, expressionType, &left_val, &right_val,
                               left->line_number);
    } else {
        char *op_str = crb_get_operator_string(expressionType);
